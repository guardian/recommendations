...
## DRY
If it's something like naming/formatting, don't write the same comment many times on a PR.  Point one example out, and make a general comment explaining there are multiple occurrences.
